...
import EasyPrivateVotingContractArtifactJson from '../../circuits/target/voting_contract-EasyPrivateVoting.json' assert { type: 'json' }
...
export class EasyPrivateVotingContract extends ContractBase {
  ...
  public static async at(address: AztecAddress, wallet: Wallet) {
    return Contract.at(
      ...
      wallet
    ) as Promise<EasyPrivateVotingContract>
  }
  ...
  public static get storage(): ContractStorageLayout<
    'admin' | 'tally' | 'vote_ended' | 'active_at_block'
  > {
    return {
      admin: {
        slot: new Fr(1n),
  ...
  public declare methods: {
    ...
    cast_vote: ((candidate: FieldLike) => ContractFunctionInteraction) &
    ...
    get_vote: ((candidate: FieldLike) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>
